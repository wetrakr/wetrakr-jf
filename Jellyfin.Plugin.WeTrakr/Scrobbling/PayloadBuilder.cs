...
{
    public ScrobblePayload Build(string eventName, BaseItem item, SessionInfo session, long positionTicks, bool isPaused, bool played, bool isOwner = false)
    {
    ...
    /// </summary>
    public ScrobblePayload BuildUserData(string eventName, BaseItem item, UserItemData userData, Guid userId, string? userName, string saveReason, bool isOwner = false)
    {
        var payload = new ScrobblePayload
        {
            Event = eventName,
